<template>
    <div class="box">
        ...
        <div class="lqlg-bot">
    		  <img src="../../assets/img/w2.png" style="margin-top:1rem;"/>
          <div class="lqlg-fixed">
            <img src="../../assets/img/w4.gif" />
            <span>零钱乐购-恭喜您获得</span>
            <p>第2550期</p>
            <p>apple/苹果 iPhoneX 64GB</p>
            <img src="../../assets/img/w3.gif">
            <p>实物晒单+2积分</p>
          </div>
    	  </div>
        <div >
...
@import "../../assets/css/reset";
    .box{
      width: 100%;background-color: #4865ff;
        &-top{
          width: 100%;
          height: 782*$r;
