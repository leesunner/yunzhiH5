<template>
  <div id="invitation">
    <div class="banner" style="position:relative;">
      <img class="img" src="../../../static/image/shoutuBanner.png" alt="">
    ...
    <div class="box">
      <img class="img" src="../../../static/image/invitation-test.png" alt="">
    </div>
    <div class="box">
...
<script>
  ...
  export default{
    components: {Cell, Group,shareView},
    name: "invitation",
    data(){
      return {
        month: "",
...
<style>
  #invitation { background:#3D0B6C; min-height:100%; padding-bottom:5px; }
